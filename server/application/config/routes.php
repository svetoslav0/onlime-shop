...
$route['get_all_products']['get'] = 'products/findAll';
$route['get_product_details/(:num)']['get'] = 'products/findById/$1';
$route['get_categories']['get'] = 'categories/findAll';
$route['get_products_in_category/(:num)']['get'] = 'products/findAllForCategory/$1';
